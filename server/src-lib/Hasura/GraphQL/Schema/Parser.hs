...
module Hasura.GraphQL.Schema.Parser
  ( -- The pattern is as follows:
    ...
    data P.FieldParser,
    InputFieldsParser,
    data P.InputFieldsParser,
    InputObjectInfo,
    data P.InputObjectInfo,
    Parser,
    data P.Parser,
    Schema,
    data P.Schema,
    ConflictingDefinitions,
    data P.ConflictingDefinitions,
    Definition,
    data P.Definition,
    Type,
    TypeInfo,
    ...
    data P.Directive,
    DirectiveInfo,
    data P.DirectiveInfo,
    FieldInfo,
    data P.FieldInfo,
    InputFieldInfo,
    data P.InputFieldInfo,
    HasTypeDefinitions,
    SomeDefinitionTypeInfo,
    data P.SomeDefinitionTypeInfo,
    TypeDefinitionsWrapper,
    data TypeDefinitionsWrapper,
    P.ParseErrorCode (..),
    toQErr,
