...
:::caution Supported Languages
  - Docusaurus uses prisma under the hood for code-block syntac highlighting. Please refer the supported languages [here](https://prismjs.com/#supported-languages).
