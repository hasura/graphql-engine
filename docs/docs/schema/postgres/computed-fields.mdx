...
<Thumbnail src='/img/graphql/core/schema/computed-field-create.png' alt='Add computed field' />
...
<Thumbnail src='/img/graphql/core/databases/postgres/schema/computed-fields-remote-relationship.png' width='700px' />
