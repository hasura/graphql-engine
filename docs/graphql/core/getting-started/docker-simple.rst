...
.. code-block:: bash
   ...
   wget https://raw.githubusercontent.com/hasura/graphql-engine/install-manifests/docker-compose/docker-compose.yaml
   # or run
   curl https://raw.githubusercontent.com/hasura/graphql-engine/install-manifests/docker-compose/docker-compose.yaml -o docker-compose.yml
