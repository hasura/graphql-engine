...
If a table cell is mixed with text and markdown stuff (`code highlighters`, [links](/migration-guide/links) etc., Please prefer `html` syntax over markdown as markdown won't be parsed correctly.
