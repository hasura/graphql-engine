...
func NewClient(hasMetadataV3 bool) *Client {
	return &Client{HasMetadataV3: hasMetadataV3}
}
...
func (c *HasuraRestAPIClient) HasDefaultDatasource() (bool, error) {
	request := struct {
		Type string            `json:"type"`
