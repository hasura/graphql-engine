...
# Cloud: Using Hasura Cloud with a Timescale Postgres database <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/timescale/select-db.png' alt='Select DB on Timescale' width='1000px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/timescale/TS-complete.png' alt='Database setup' width='600px' />
