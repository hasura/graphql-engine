...
-   You can [rename](/graphql/cloud/projects/details.mdx) your new project to the same name
...
API endpoint, you can simply [rename](/graphql/cloud/projects/details.mdx) your new project
