...
Install can be done via the usual installation commands with the following [guide](/enterprise/control-plane/index.mdx).
...
<Thumbnail src='/img/enterprise/lux-2.0-upgrade-fix.gif' alt='Upgrade Lux' />
