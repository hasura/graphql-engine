...
# Postgres: Setting Values for Rields Using Role-Based Column Presets
...
<Thumbnail src='/img/schema/column-presets-option.png' alt='Add a column preset in the permissions tab' />
...
<Thumbnail src='/img/schema/column-presets-value-options.png' alt='Configure the column preset' />
...
<Thumbnail src='/img/schema/column-preset-mutation-result.png' alt='Write an insert mutation' />
