...
<Thumbnail src='/img/databases/citus-hyperscale-postgres/connect-citus-db_console_2.10.1.png' alt='Add source' width='600px' />

If you're testing Hasura with Citus running locally, [read this guide](/guides/docker-networking.mdx) on Docker
networking in case you're not sure how to make sure that your Citus database is reachable from the Hasura docker
