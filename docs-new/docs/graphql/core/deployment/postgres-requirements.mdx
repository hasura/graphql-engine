...
## Supported Postgres versions {#postgres_version_support}
...
a new user and giving the [above](/graphql/core/deployment/postgres-requirements.mdx#postgres-permissions) privileges,
