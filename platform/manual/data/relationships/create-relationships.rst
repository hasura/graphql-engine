...
.. tabs::
   ...
   .. tab:: Using Foreign Keys
      ...
      .. image:: ../../../../img/platform/manual/data/relationships/suggested-relationships.png

      Click on *Add* to add a new object relationship and give it the name ``author``:

      .. image:: ../../../../img/platform/manual/data/relationships/create-relationship.png

      The relationship is created:

      .. image:: ../../../../img/platform/manual/data/relationships/created-relationship.png
   ...
   .. tab:: Without Foreign Keys
      ...
      .. image:: ../../../../img/platform/manual/data/relationships/manual-relationship.png
