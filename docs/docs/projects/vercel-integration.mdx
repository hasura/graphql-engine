...
# Cloud: Vercel Integration <HeadingIcon icon={`cloud`} size={36} />
...
- Once you are logged in, a Hasura Cloud project is created for the integration and the required
  ...
  <Thumbnail src='/img/graphql/cloud/integrations/vercel/setup-progress.png' alt='Setup Progress' width='600px' />
...
- Click on the first link to navigate to your Hasura Cloud project Console to configure your GraphQL API and connect to
  ...
  <Thumbnail src='/img/graphql/cloud/integrations/vercel/visit-console.png' alt='Visit Console Button' width='600px' />
