.. meta::
   :description: Manage relationships between tables/views in Hasura using Postgres
   :keywords: hasura, docs, schema, relationship, postgres

.. _table_relationships_postgres:
