...
also take a look at the [Logical Models documentation](/schema/postgres/logical-models.mdx).
...
[Logical Model documentation](/schema/postgres/logical-models.mdx) for information on attaching permissions.
...
more information in the relevant documentation for [filtering](/queries/postgres/filters/index.mdx),
...
[documentation on Logical Models](/schema/postgres/logical-models.mdx) for an explanation of how to add permissions.
