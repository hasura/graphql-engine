...
You can modify a table column by using the [run_sql](/graphql/core/api-reference/schema-api/run-sql.mdx) schema API:
...
You can create a trigger by using the [run_sql](/graphql/core/api-reference/schema-api/run-sql.mdx) schema API:
