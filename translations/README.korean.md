...
2. Hasura 콘솔 열기
   ...
   `https://<app-name>.herokuapp.com` (_반드시 \<app-name\> 을 당신의 앱 이름으로 바꿔야합니다._) 에 들어가서 어드민 콘솔을 여세요.
...
- [개인 호스트 gitlab 인스턴스에 GraphQL 추가하기](https://www.youtube.com/watch?v=a2AhxKqd82Q) (_3:44 분_)
- [Auth0와 GraphQL 백엔드가 있는 Todo app](https://www.youtube.com/watch?v=15ITBYnccgc) (_4:00 분_)
- [GitLab 인증과 통합된 GitLab의 GraphQL](https://www.youtube.com/watch?v=m1ChRhRLq7o) (_4:05 분_)
- [천만대의 탈것와 위치기반(PostGIS, Timescale) 을 위한 대시보드](https://www.youtube.com/watch?v=tsY573yyGWA) (_3:06 분_)
