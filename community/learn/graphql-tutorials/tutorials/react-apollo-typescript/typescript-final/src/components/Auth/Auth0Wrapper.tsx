...
export default class Auth0Wrapper extends React.Component<any, any> {
  ...
  isExpired (): Boolean | null {
    ...
    return new Date().getTime() > (expiresAt ? expiresAt : 0);
  }
  ...
  render() {
    ...
    return (<App {...this.props} auth={{isAuthenticated: this.state.isAuthenticated, idToken: this.state.idToken, login: this.login, logout: this.logout}} />);
  }
