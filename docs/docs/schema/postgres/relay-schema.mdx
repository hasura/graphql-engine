...
[export the GraphQL schema](/guides/export-graphql-schema.mdx). But instead of the GraphQL endpoint, you can specify the
Relay endpoint, which will end in `/v1beta1/relay`.
