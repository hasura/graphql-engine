...
# Cloud & EE: Errors <HeadingIcon icon={`cloud-ee`} size={36} />

Troubleshoot errors quickly with powerful analytical tools and filters:

<Thumbnail src='/img/graphql/cloud/metrics/pro-tab-errors.png' alt='Hasura Cloud Console errors tab' />
...
<Thumbnail src='/img/graphql/cloud/metrics/inspect-error.png' alt='Hasura Cloud Console inspect a failed operation' />
