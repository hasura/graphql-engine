...
## pg_create_array_relationship {#pg-create-array-relationship}
...
## pg_drop_relationship {#pg-drop-relationship}
...
## pg_set_relationship_comment {#pg-set-relationship-comment}
...
## pg_rename_relationship {#pg-rename-relationship}
