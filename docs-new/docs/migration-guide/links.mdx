...
![Referencing sub-section in rst vs markdown](/img/migration-guide/link-sub-section-ids.png)
:::
...
```markdown
[Getting Started with Hasura Cloud](/graphql/cloud/getting-started/index.mdx)
```

The Result UI: [Getting Started with Hasura Cloud](/graphql/cloud/getting-started/index.mdx)
