...
<Thumbnail
  src="/img/graphql/core/schema/create-table-graphql-bigquery.png"
...
Tables can be present in the underlying BigQuery database without being
...
<Thumbnail
  src="/img/graphql/core/schema/schema-track-tables-bigquery.png"
  alt="Track table"
/>
...
following API call to the [bigquery_track_table](/api-reference/metadata-api/table-view.mdx#metadata-bigquery-track-table) metadata API:
...
- `id`, `title`, `body`, and so on are fields of the
  `Articles` type
...
These auto-generated fields will allow you to query data in
the table.

See the [query](/api-reference/graphql-api/query.mdx) API reference for the full
specifications.
