...
const quote = require('./images/quote.svg');
const EvePorcello = require('./images/Eve-Porcello.png');
const Sibylle = require('./images/Sibylle.png');
const Imani = require('./images/Imani.png');
