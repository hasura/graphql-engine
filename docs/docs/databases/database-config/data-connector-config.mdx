...
Templates are written using the [Kriti templating language](/api-reference/kriti-templating.mdx).
...
Template variables are supported on Hasura GraphQL Engine from v2.35.0 onwards.<br/>
