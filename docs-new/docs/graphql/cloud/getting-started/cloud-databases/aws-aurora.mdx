...
[step 2](/graphql/cloud/getting-started/cloud-databases/aws-aurora.mdx#create-pg-aws-rds-aurora).
...
[step 4](/graphql/cloud/getting-started/cloud-databases/aws-aurora.mdx#construct-db-url-aurora):
