...
data RemoteField =
  RemoteField
    ...
    , rmfGType              :: !G.GType
    , rmfParamMap           :: !(HashMap G.Name VT.InpValInfo)
    }
...
parseJsonInpValInfo :: Value -> AT.Parser VT.InpValInfo
...
toJsonInpValInfo :: VT.InpValInfo -> Value
toJsonInpValInfo VT.InpValInfo {..} =
  object
    [ "desc" .= _iviDesc
    , "name" .= _iviName
