...
[Create a migration manually](/migrations-metadata-seeds/manage-migrations.mdx#create-manual-migrations) and add the following
...
You can add a `created_at` timestamp by using the [run_sql](/api-reference/schema-api/run-sql.mdx#schema-run-sql) schema API:
...
[Create a migration manually](/migrations-metadata-seeds/manage-migrations.mdx#create-manual-migrations) and add the below SQL
...
You can add an `updated_at` timestamp by using the [run_sql](/api-reference/schema-api/run-sql.mdx#schema-run-sql) schema API.
