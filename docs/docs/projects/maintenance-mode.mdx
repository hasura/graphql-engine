...
# Cloud: Maintenance mode <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/projects/maintenance-mode.png' alt='Project with maintenance mode activated' />
