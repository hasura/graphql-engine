...
#. :ref:`You already have a database and Hasura setup <migrations_existing_db_v1>`.
#. :ref:`You're starting from scratch - an empty database and a fresh Hasura instance <migrations_new_db_v1>`.
