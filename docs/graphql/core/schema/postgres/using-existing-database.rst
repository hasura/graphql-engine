.. meta::
   :description: Set up a Hasura GraphQL schema with an existing Postgres database
   :keywords: hasura, docs, schema, existing database, postgres

.. _schema_existing_db_postgres:
