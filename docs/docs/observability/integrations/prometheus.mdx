...
<Thumbnail src='/img/graphql/cloud/metrics/prometheus-access-token.png' alt='Prometheus Access Token' width='1146px' />
...
<Thumbnail src='/img/graphql/cloud/metrics/prometheus-view-metrics.png' alt='Prometheus view Metrics' width='1200px' />
