...
title: 'Cloud: Project ownership transfer'
keywords:
  - hasura
  - docs
  - project
...
# Cloud: Project ownership transfer <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/projects/transfer-ownership.png' alt='Transfer Project Ownership' width='1146px' />
