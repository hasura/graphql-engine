...
# Cloud: Using Hasura Cloud with a GCP Postgres database <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/gcp/navigate-to-sql.png' alt='Navigate to SQL in GCP' width='250px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/gcp/connections.png' alt='Navigate to connections in GCP' width='600px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/gcp/add-network.png' alt='Add a new network in GCP' width='600px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/gcp/GCP-complete.png' alt='Database setup' width='600px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/gcp/cloud-gcp-env-vars.png' alt='Hasura Cloud Env Vars' width='1000px' />
