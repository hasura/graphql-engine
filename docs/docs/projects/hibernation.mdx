...
title: 'Cloud: Project Hibernation and Reactivation'
keywords:
  - hasura
  - docs
  - project
...
# Cloud: Project Hibernation and Reactivation <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail
  src='/img/projects/reactivation-owner.png'
...
<Thumbnail
  src='/img/projects/reactivation-collaborator.png'
