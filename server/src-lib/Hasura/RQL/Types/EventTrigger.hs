...
instance FromJSON CreateEventTriggerQuery where
  parseJSON (Object o) = do
    ...
    return $ CreateEventTriggerQuery name table insert update delete (Just enableManual) retryConf webhook webhookFromEnv headers replace comment
    where
      checkEmptyCols spec
        = case spec of
