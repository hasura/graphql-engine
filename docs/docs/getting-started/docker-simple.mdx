...
<Thumbnail src='/img/getting-started/connect-database-docker_step-3_console_2-12-0.png' alt='Connect database' width='1000px' />

Enter your database connection URL. _(See the note below if you do not have an existing database)_

Click `Connect Database`.

<Thumbnail src='/img/getting-started/connect-database-docker_step-3_2nd_console_2-12-0.png' alt='Enter URL for existing database' width='700px' />
...
<Thumbnail src='/img/getting-started/connect-database-docker_step-4_console_2-12-0.png' alt='Create a table' width='1200px' />
...
<Thumbnail src='/img/getting-started/connect-database-docker_step-4_2nd_console_2-12-0.png' alt='Try out a query' width='1200px' />
