...
You can enable SSL connection on your GCP Postgres Database. Please check out our [GCP Postgres SSL Connection Guide](/graphql/cloud/getting-started/cloud-databases/gcp-ssl-postgres.mdx) for more details.
