...
--          and note: "Holding a normal ThreadId reference will prevent the delivery of BlockedIndefinitely
--          exceptions because the reference could be used as the target of throwTo at any time,  "
