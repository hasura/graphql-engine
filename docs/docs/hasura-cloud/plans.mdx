...
an advanced database connection, **you are billed only once for an advanced database connection no matter how many or
how different types you add**.

| Database Type      | Rate            |
| ------------------ | --------------- |
| Generic Postgres   | $1.50/active-hr |
| MongoDB            | $3.00/active-hr |
