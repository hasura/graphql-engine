...
## create_insert_permission {#create-insert-permission}
...
### Args syntax {#create-insert-permission-syntax}
...
## drop_insert_permission {#drop-insert-permission}
...
### Args syntax {#drop-insert-permission-syntax}
...
## create_select_permission {#create-select-permission}
...
### Args syntax {#create-select-permission-syntax}
...
## drop_select_permission {#drop-select-permission}
...
### Args syntax {#drop-select-permission-syntax}
...
## create_update_permission [#create-update-permission]
...
### Args syntax {#create-update-permission-syntax}
...
## drop_update_permission {#drop-update-permission}
...
### Args syntax {#drop-update-permission-syntax}
...
## create_delete_permission {#create-delete-permission}
...
### Args syntax {#create-delete-permission-syntax}
...
## drop_delete_permission {#drop-delete-permission}
...
### Args syntax {#drop-delete-permission-syntax}
...
## set_permission_comment {#set-permission-comment}
...
### Args syntax {#set-permission-comment-syntax}
