...
- **Postgres** ❤️: Supporte les types Postgres (PostGIS/geo-location, etc.), transforme les vues en _graphs_, déclenche des procédures ou fonctions stockées via les mutations.
...
2. Ouvrez la console Hasura
   ...
   Visitez `https://<app-name>.herokuapp.com` (_remplacez \<app-name\> par le nom de votre application_) pour ouvrir la console d'administration.
