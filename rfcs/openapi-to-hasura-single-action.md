...
The most common use case for Hasura actions is to integrate with a REST endpoint. This RFC proposes a way to import REST endpoints into Hasura GraphQL Engine via as  Hasura actions. This allows users to create a unified API across varied data sources such as databases, GraphQL APIs and REST APIs seamlessly.
