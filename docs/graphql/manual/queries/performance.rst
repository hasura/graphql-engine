...
.. thumbnail:: /img/core/queries/analyze-query.png
   :class: no-shadow
   :width: 75%
...
.. thumbnail:: /img/core/queries/query-analysis-before-index.png
   :class: no-shadow
   :width: 75%
...
.. thumbnail:: /img/core/queries/query-analysis-after-index.png
   :class: no-shadow
   :width: 75%
   :alt: Execution plan for Hasura GraphQL query
