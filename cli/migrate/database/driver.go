...
type Driver interface {
	...
	Open(url string, isCMD bool, tls *tls.Config, logger *log.Logger) (Driver, error)
...
func Open(url string, isCMD bool, tls *tls.Config, logger *log.Logger) (Driver, error) {
	...
	return d.Open(url, isCMD, tls, logger)
}
