...
On the [_Sign in](https://cloud.hasura.io/login?redirect_url=/) page, select `Forgot?`.
...
You can now log in with the email and this new password and follow the steps mentioned above in the [change email](#email-change) section.
