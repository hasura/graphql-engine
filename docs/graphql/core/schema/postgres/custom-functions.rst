.. meta::
   :description: Customise the Hasura GraphQL schema with SQL functions using Postgres
   :keywords: hasura, docs, schema, custom function, postgres

.. _custom_sql_functions_postgres:
