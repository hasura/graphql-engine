...
Switch versions and observe below to see how docusaurus parses file path links and result in full URL path for different versions
Base URL is always prefixed.

`[=>](/migration-guide/index.mdx#contents-covered)`
