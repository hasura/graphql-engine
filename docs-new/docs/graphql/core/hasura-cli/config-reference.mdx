...
| `HASURA_GRAPHQL_API_PATHS_QUERY`                 | `api_paths.query`                 | Schema/ metadata API endpoint. More details at [Schema / metadata API (Deprecated)](/graphql/core/api-reference/index.mdx#schema_metadata_api). |
| `HASURA_GRAPHQL_API_PATHS_GRAPHQL`               | `api_paths.graphql`               | GraphQL API endpoint. More details at [GraphQL API](/graphql/core/api-reference/index.mdx#graphql_api).                                         |
| `HASURA_GRAPHQL_API_PATHS_CONFIG`                | `api_paths.config`                | Config API endpoint. More details at [Config API](/graphql/core/api-reference/index.mdx#config_api)`.                                           |
| `HASURA_GRAPHQL_API_PATHS_PG_DUMP`               | `api_paths.pg_dump`               | PG Dump API endpoint. More details at [pg_dump API](/graphql/core/api-reference/index.mdx#pg_dump_api).                                         |
| `HASURA_GRAPHQL_API_PATHS_VERSION`               | `api_paths.version`               | Version API endpoint. More details at [RESTified GraphQL API](/graphql/core/api-reference/index.mdx#version_api).                               |
