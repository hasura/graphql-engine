...
<Tabs className="api-tabs">
  <TabItem value="cli" label="CLI">
    ...
    <Link to="/graphql/core/hasura-cli/hasura_metadata_export">
...
<Tabs className="api-tabs">
<TabItem value="cli" label="CLI">
Metadata can be applied with the <Link to="/graphql/core/hasura-cli/hasura_metadata_apply">
...
<TabItem value="cli" label="CLI">
Metadata can be reloaded with the <Link to="/graphql/core/hasura-cli/hasura_metadata_reload.mdx">hasura metadata reload</Link> command.
</TabItem>
<TabItem value="console" label="Console">
1.Click on the settings (⚙) icon at the top right corner of the
console screen.
...
<TabItem value="cli" label="CLI">
Metadata can be reset with the <Link to="/graphql/core/hasura-cli/hasura_metadata_clear.mdx">hasura metadata clear</Link> command.
</TabItem>
<TabItem value="console" label="Console">
1.Click on the settings (⚙) icon at the top right corner of the
console screen.
