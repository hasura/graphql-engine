...
[subscriptions](/graphql/core/databases/ms-sql-server/subscriptions/index.mdx#ms-sql-server-subscriptions), two subscriptions will
need to be run as Hasura follows the [GraphQL
