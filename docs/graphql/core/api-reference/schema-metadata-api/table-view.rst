...
.. _schema_metadata_api_tables_views:
...
.. _schema_metadata_track_table_syntax:
...
.. list-table::
   ...
   * - is_enum
     - false
     - Boolean
     - When set to ``true``, creates the table as an :ref:`enum table <pg_create_enum_table>`.

.. _schema_metadata_set_table_is_enum:

set_table_is_enum
-----------------

``set_table_is_enum`` sets whether an already-tracked table should be used as an :ref:`enum table <pg_create_enum_table>`.
...
.. _schema_metadata_set_table_is_enum_syntax:
...
.. _schema_metadata_track_table_v2:
...
.. note::
  ...
  GraphQL engine requires the constraint names (if any) of a table to be `GraphQL compliant <https://spec.graphql.org/June2018/#sec-Names>`__
  in order to be able to track it.

.. _schema_metadata_track_table_syntax_v2:
...
.. _schema_metadata_set_table_custom_fields:

set_table_custom_fields (deprecated)
------------------------------------

``set_table_custom_fields`` has been deprecated. Use the
:ref:`set_table_customization <schema_metadata_set_table_customization>` API to set the custom
table fields.
...
.. _schema_metadata_set_table_custom_fields_syntax:
...
.. _schema_metadata_set_table_customization:
...
:ref:`set_table_custom_fields <schema_metadata_set_table_custom_fields>` has been deprecated in
favour of this API.
...
.. _schema_metadata_set_table_customization_syntax:
...
.. _schema_metadata_untrack_table:
...
.. _schema_metadata_untrack_table_syntax:
