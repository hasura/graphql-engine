...
<div
  className="badge badge--primary heading-badge"
...
2.  Go to `Integrations` tab and click on the Heroku integration under `Databases`
    ...
    <Thumbnail
      src="/img/projects/heroku-integration.png"
...
4.  Now you can go ahead to your project console's `Data` tab and connect the database through the env var that you
    ...
    <Thumbnail
      src="/img/projects/heroku-db-connect.png"
...
2.  Click on `Opt out of the sync` button next to Heroku note.
    ...
    <Thumbnail
      src="/img/projects/heroku-db-sync-enabled-new.png"
      alt="Enabled DB Sync"
      width="1100px"
    />
...
<Thumbnail
  src="/img/projects/heroku-delete-integration.png"
