...
**(Deprecated in versions > v2.0.0. [See details](/guides/upgrade-hasura-v2.mdx#hasura-v2-env-changes))**
...
`HASURA_GRAPHQL_ENABLE_METADATDA_QUERY_LOGGING`
