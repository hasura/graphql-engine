...
export const VariantWithTooltip: ComponentStory<typeof AdvancedSelectField> =
  () => {
    const options = [
      { value: 'value0', label: 'Value 0' },
      { value: 'value1', label: 'Value 1', disabled: true },
...
export const StateWithDefaultValue: ComponentStory<typeof AdvancedSelectField> =
  () => {
    const options = [
...
export const StateWithErrorMessage: ComponentStory<typeof AdvancedSelectField> =
  () => {
    const options = [
      { value: 'value0', label: 'Value 0' },
      { value: 'value1', label: 'Value 1', disabled: true },
...
export const TestingScalability: ComponentStory<typeof AdvancedSelectField> =
  () => {
    const options = [
      { value: 'value0', label: 'Value 0' },
      { value: 'value1', label: 'Value 1', disabled: true },
