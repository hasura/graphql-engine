...
If you are looking for adding authorization & access control for your app users to the GraphQL APIs that are auto-generated via Hasura, head to [Authentication & Authorization](/auth/index.mdx).

:::

:::info Health monitoring of remote schemas in Hasura Cloud

Hasura Cloud offers built-in API metrics with integrated health checks and distributed tracing for your remote
schemas. Read more at [Distributed Tracing in Hasura Cloud](/observability/tracing.mdx).
