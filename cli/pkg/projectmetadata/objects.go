...
import (
	...
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/actions"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/allowlist"
	apilimits "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/api_limits"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/backend_configs"
	crontriggers "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/cron_triggers"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/functions"
	graphqlschemaintrospection "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/graphql_schema_introspection"
	inheritedroles "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/inherited_roles"
	metricsconfig "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/metrics_config"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/network"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/opentelemetry"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/querycollections"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/remoteschemas"
	restendpoints "github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/rest_endpoints"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/sources"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/tables"
	"github.com/hasura/graphql-engine/cli/v2/pkg/metadataobject/version"
)
