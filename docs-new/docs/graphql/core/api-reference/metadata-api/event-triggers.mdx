...
| transform        | false    | [RequestTransformation](/graphql/core/api-reference/syntax-defs.mdx#requesttransformation)                                                                          | Attaches a Request Transformation to the Event Trigger.               |
