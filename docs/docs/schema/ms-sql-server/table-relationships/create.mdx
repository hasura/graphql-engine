...
<Thumbnail src='/img/graphql/core/schema/add-foreign-key-mssql.png' alt='Add foreign-key constraint' width='700px' />
...
<Thumbnail src='/img/graphql/core/schema/schema-track-relationships.png' alt='Track all relationships' width='800px' />
