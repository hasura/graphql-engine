...
- [Append a json to a jsonb column](#append-a-json-to-a-jsonb-column)
- [Prepend a json to a jsonb column](#prepend-a-json-to-a-jsonb-column)
- [Delete a top-level key from a jsonb column](#delete-a-top-level-key-from-a-jsonb-column)
- [Delete an element from a jsonb column storing a json array](#delete-an-element-from-a-jsonb-column-storing-a-json-array)
- [Delete an element at a specific path in a jsonb column](#delete-an-element-at-a-specific-path-in-a-jsonb-column)
