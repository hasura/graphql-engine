---
sidebar_label: Clean up event data
sidebar_position: 6
...
Hasura stores event data associated with Event Triggers in **the
\`hdb_catalog\` schema of the database containing the source table**.

If there are lots of events, the metadata tables can get huge and you
may want to prune them. You can use any of the following options to
prune your event data depending on your need.
