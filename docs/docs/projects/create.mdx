...
<Thumbnail src='/img/graphql/cloud/projects/create-new-project.png' alt='create new project button' width='400px' />
...
<Thumbnail src='/img/graphql/cloud/projects/project-setup.png' alt='project setup' width='1100px' />
