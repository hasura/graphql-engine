...
func assetsConsoleHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/console.html", size: 1728, mode: os.FileMode(436), modTime: time.Unix(1530527475, 0)}
