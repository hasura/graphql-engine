...
<Thumbnail src="/docs/assets/graphql/cloud/billing/add_new_card.png" alt="add a new card" width="437px" />

<CustomImage src={"/assets/graphql/cloud/billing/add_new_card.png"} alt="add a new card" width="437px" />
