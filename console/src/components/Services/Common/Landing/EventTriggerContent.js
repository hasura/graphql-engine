...
const EventTriggerContent = ({ styles }) => (
  <div>
    <div className={styles.listItems + ' ' + styles.addPaddTop}>
      <div className={styles.yellowCircle} />
      <div className={styles.descriptionText}>
        <span className={styles.fontWeightBold}>Head to the DATA tab</span> and
        create a table, say `user`, with columns `id` and `name`
      </div>
    </div>
    ...
    <div className={styles.listItems}>
      <div className={styles.descriptionText + ' ' + styles.addPaddLeft}>
        ...
        <span className={styles.fontWeightBold}>Add</span> button at the top of
        this page.
      </div>
    </div>
    <div className={styles.listItems}>
      <div className={styles.descriptionText + ' ' + styles.addPaddLeft}>
        3. Set the name as “test-trigger”. Choose `user` table and select all
        operations. Enter the above URL as{' '}
    ...
    <div className={styles.listItems}>
      <div className={styles.descriptionText + ' ' + styles.addPaddLeft}>
        4. Click on the{' '}
        <span className={styles.fontWeightBold}>Add Event Trigger</span> button
        - That’s it!
      </div>
    </div>
    <div className={styles.listItems}>
