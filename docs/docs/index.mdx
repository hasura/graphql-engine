...
<div className='gallery'>
  <div className='sub-heading'>
    <p>
      ...
      the Hasura GraphQL Engine while giving you an enterprise-ready solution - complete with key features like
      observability, security, and performance - deployable in minutes. Designed to work with your container platform of
      choice, Hasura EE can quickly be set up on AWS ECS, Kubernetes, and Google Cloud Run.
    </p>
  </div>
  <div className='sub-heading'>
