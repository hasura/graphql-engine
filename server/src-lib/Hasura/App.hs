...
instance HttpLog AppM where
  ...
  logHttpSuccess logger userInfoM reqId httpReq respSize qTime cType headers eTagM =
    unLogger logger $ mkHttpLog $
      mkHttpAccessLogContext userInfoM reqId httpReq respSize qTime cType headers eTagM
