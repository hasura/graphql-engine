...
### [Traefik](https://nginx.org/en/docs/)

Here are sample `traefik.toml` and `traefik-dynamic.toml` to proxy requests to Hasura:
...
Please note that setting up SSL is not covered in this guide. You can
find more information at [Traefik docs](https://doc.traefik.io/traefik/https/overview).
