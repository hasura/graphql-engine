...
Step 0: Disable the GraphQL Engine's console GUI and serve the console locally instead
-----------------------------------------
Hasura's console GUI can be served directly by the GraphQL engine or from the CLI.
