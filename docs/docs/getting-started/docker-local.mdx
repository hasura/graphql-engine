...
Now you can apply the migrations and metadata to any Hasura instance. For example, to sync with [cloud.hasura.io](https://cloud.hasura.io/signup/?pg=docs&plcmt=body&cta=navigate-to-cloud-hasura-io&tech=default) you can use the [Github integration](/deployment/github-integration.mdx) or the Hasura CLI:
