...
## create_cron_trigger {#create-cron-trigger}
...
### Args syntax {#create-cron-trigger-syntax}
...
## delete_cron_trigger {#delete-cron-trigger}
...
### Args syntax {#delete-cron-trigger-syntax}
...
### Args syntax {#create-scheduled-event-syntax}
