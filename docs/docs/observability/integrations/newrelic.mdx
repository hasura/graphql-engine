...
title: 'Cloud & EE: New Relic Integration'
keywords:
  - hasura
  - docs
  - metrics
...
# Cloud & EE: New Relic Integration <HeadingIcon icon={`cloud-ee`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/metrics/configure-newrelic.png' alt='Configure New Relic Integration' />
