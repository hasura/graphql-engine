...
### Args syntax {#schema-metadata-track-table-v2-syntax}
...
## set_table_custom_fields (deprecated) {#schema-metadata-set-table-custom-fields-deprecated}
...
### Args syntax {#schema-metadata-set-table-custom-fields-deprecated-syntax}
