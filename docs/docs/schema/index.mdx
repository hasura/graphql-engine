...
Hasura supports many types out of the box. For strings, Hasura can recognize and return UTF-8 encoded string types from your database.

If string-type columns in your database have an encoding other than UTF-8, unexpected values may be returned for queries made on those columns.
