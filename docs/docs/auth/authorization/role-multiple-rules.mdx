...
<Thumbnail src='/img/auth/multiple-rules-create-manual-relationship.png' alt='Create a manual object relationship' />
...
<Thumbnail src='/img/auth/multiple-rules-define-public-permissions.png' alt='Column access for the role user' />
...
<Thumbnail
  src='/img/auth/multiple-rules-define-private-permissions.png'
