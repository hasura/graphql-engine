...
- `Using Hasura Cloud <https://hasura.io/docs/cloud/1.0/manual/projects/create.html#create-new-project-with-new-database-on-heroku>`__ **(recommended)**: Create a new Hasura Cloud project with just one click.
...
- `Using Hasura Cloud <https://hasura.io/docs/cloud/1.0/manual/projects/create.html#create-new-project-with-an-existing-postgres-database>`__ **(recommended)**: Create a new Hasura Cloud project connected to an existing Postgres database.
