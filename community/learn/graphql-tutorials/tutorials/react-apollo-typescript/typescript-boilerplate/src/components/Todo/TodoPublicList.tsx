...
import { TodoPublicListState } from './TodoTypeDefs';

class TodoPublicList extends Component<any, TodoPublicListState> {
  constructor(props: TodoPublicListState) {
    super(props);
  ...
  render() {
    ...
    let newTodosNotification = '' as any;
