...
Due to the way nested inserts are typically handled (described [here](/graphql/core/databases/postgres/mutations/insert.mdx)), the order of object insertion needs to be
