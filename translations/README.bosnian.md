...
- **Postgres** ❤️: Podržava Postgres tipove (PostGIS/geo-location, i sl.), pretvara poglede u _grafikone_, pokreće pohranjene funkcije ili procedure s mutacijama
...
2. Otvori Hasura konzolu
   ...
   Posjeti `https://<app-name>.herokuapp.com` (_zamijeni \<app-name\> sa nazivom svoje aplikacije_) da otvoriš administratorsku konzolu.
...
- [Dodajte GraphQL u samostojeću GitLab instancu](https://www.youtube.com/watch?v=a2AhxKqd82Q) (_3:44 min_)
- [Todo aplikacija sa Auth0 i GraphQL backendom](https://www.youtube.com/watch?v=15ITBYnccgc) (_4:00 min_)
- [GraphQL na GitLab-u integrirana sa GitLab autentikacijom](https://www.youtube.com/watch?v=m1ChRhRLq7o) (_4:05 min_)
- [Nadzorna ploča za 10 miliona vožnji sa geografskom lokacijom (PostGIS, Timescale)](https://www.youtube.com/watch?v=tsY573yyGWA) (_3:06 min_)
