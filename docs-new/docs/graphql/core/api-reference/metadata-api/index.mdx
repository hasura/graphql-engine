...
| [pg_untrack_function](/graphql/core/api-reference/metadata-api/custom-functions.mdx#metadata-pg-untrack-function)                                      | [FunctionName](/graphql/core/api-reference/syntax-defs.mdx#functionname)                                                                                              | 1         | Remove a Postgres SQL function                                         |
