...
1.  passing a [Table Config](/api-reference/syntax-defs.mdx#table-config) with the [ColumnConfig](/api-reference/syntax-defs.mdx#columnconfig) to the
...
2.  using the [pg_set_table_customization](/api-reference/metadata-api/table-view.mdx#metadata-pg-set-table-customization) API to set the
    [ColumnConfig](/api-reference/syntax-defs.mdx#columnconfig):
...
1.  passing a [Table Config](/api-reference/syntax-defs.mdx#table-config) with the [Custom Root Fields](/api-reference/syntax-defs.mdx#custom-root-fields) names to the
    [pg_track_table](/api-reference/metadata-api/table-view.mdx#metadata-pg-track-table) API while tracking a table:
...
2.  using the [pg_set_table_customization](/api-reference/metadata-api/table-view.mdx#metadata-pg-set-table-customization) metadata API to set
    the [Custom Root Fields](/api-reference/syntax-defs.mdx#custom-root-fields) names
