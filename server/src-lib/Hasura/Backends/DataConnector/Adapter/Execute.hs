...
instance BackendExecute 'DataConnector where
  ...
  mkDBMutationPlan _env _manager _logger UserInfo {..} _stringifyNum sourceName sourceConfig mutationDB _headers _gName _maybeSelSetArgs _traceQueryStatus = do
