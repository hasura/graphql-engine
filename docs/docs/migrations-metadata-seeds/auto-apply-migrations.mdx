...
[images](https://github.com/hasura/graphql-engine/tree/master/install-manifests). This container provides a method to
apply [Migrations and Metadata](/migrations-metadata-seeds/overview.mdx) automatically when the container starts up. It
works by:
