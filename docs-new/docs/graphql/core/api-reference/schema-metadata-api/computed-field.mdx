...
## add_computed_field {#add-computed-field}
...
### Args syntax {#add-computed-field-syntax}
...
## drop_computed_field {#drop-computed-field}
...
### Args syntax {#drop-computed-field-syntax}

| Key     | Required | Schema                                                                               | Description                                                                                   |
|---------|----------|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| table   | true     | [TableName](/graphql/core/api-reference/syntax-defs.mdx#tablename)                   | Name of the table                                                                             |
| name    | true     | [ComputedFieldName](/graphql/core/api-reference/syntax-defs.html#computedfieldname)  | Name of the computed field                                                                    |
