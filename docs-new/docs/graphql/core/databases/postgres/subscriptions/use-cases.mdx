...
can [create a view to query the derived data](/graphql/core/databases/postgres/schema/views.mdx#pg-custom-views) and then use subscriptions to fetch the derived
