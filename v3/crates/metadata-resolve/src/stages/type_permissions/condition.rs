...
pub fn resolve_condition(
    ...
    match condition {
        ...
        open_dds::authorization::Condition::Equal { left, right } => Condition::BinaryOperation {
            op: BinaryOperation::Equals,
            left: resolve_value_expression(flags, left.clone()),
            right: resolve_value_expression(flags, right.clone()),
        },
        open_dds::authorization::Condition::Contains { left, right } => {
        ...
        open_dds::authorization::Condition::GreaterThan { left, right } => {
            Condition::BinaryOperation {
        ...
        open_dds::authorization::Condition::LessThan { left, right } => {
            Condition::BinaryOperation {
        ...
        open_dds::authorization::Condition::GreaterThanOrEqual { left, right } => {
            Condition::BinaryOperation {
        ...
        open_dds::authorization::Condition::LessThanOrEqual { left, right } => {
            Condition::BinaryOperation {
