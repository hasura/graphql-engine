...
title: 'Cloud: Switching pricing plans'
keywords:
  - hasura
  - docs
  - cloud
  - pricing
sidebar_position: 8
sidebar_label: Hasura Cloud pricing
---

import Thumbnail from '@site/src/components/Thumbnail';
import HeadingIcon from '@site/src/components/HeadingIcon';

# Cloud: Switching pricing plans <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/projects/project-pricing-plans.png' alt='Billing overview' width='1200px' />
