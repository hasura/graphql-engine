.. meta::
   :description: Use variables, aliases, fragments and directives in Hasura queries using Postgres
   :keywords: hasura, docs, query, variable, alias, fragment, directive, postgres

.. _variables_aliases_fragments_directives_postgres:
