...
>
  ...
  <div class="cursor-pointer flex items-center text-sm text-muted">
    <svg class="w-5 fill-current mr-xs" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 21h15.893c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zm0-2v-5h4v5H4zM14 7v5h-4V7h4zM8 7v5H4V7h4zm2 12v-5h4v5h-4zm6 0v-5h3.894v5H16zm3.893-7H16V7h3.893v5z"></path></svg>
    <span class="">public</span>
  </div>
</div>

<h1 class="text-xl font-semibold mb-md">Breadcrumbs</h1>

<h2 class="text-lg font-semibold mb-xs">What are breadcrumbs?</h2>
...
<p class="mb-md text-muted">
  Breadcrumbs are useful for un-packing nested navigations - anywhere where the
  user views an expanded page and drills further in for more information.
</p>
