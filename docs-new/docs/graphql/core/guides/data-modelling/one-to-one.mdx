...
[here](https://hasura.io/docs/latest/graphql/core/databases/postgres/mutations/insert.mdx)), the order of object insertion needs to be
specified using the [insertion_order](/graphql/core/api-reference/syntax-defs.mdx) option
