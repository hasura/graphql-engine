...
```
{  
[PGColumn](#pgcolumn) | scalar [ComputedFieldName](#computedfieldname) : { [Operator](#operator) : Value }
}
```
...
{  
    ...
    "customization": [RemoteSchemaCustomization](#remoteschemacustomization)
}
```
