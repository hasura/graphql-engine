...
## create_rest_endpoint {#create-rest-endpoint}
...
### Args syntax {#create-rest-endpoint-syntax}
...
## drop_rest_endpoint {#drop-rest-endpoint}
...
### Args syntax {#drop-rest-endpoint-syntax}
