...
Hasura GraphQL Engine - это сверхбыстрый графический сервер позволяющий создавать **мгновенно GraphQL API на основе Postgres**, с [**webhook triggers**](../event-triggers.md), и [**remote schemas**](../remote-schemas.md) для бизнес-логики.
...
- [Быстрый запуск:](#быстрый_запуск)
    - [Деплоймент одним кликом на Heroku](#деплоймент_одним_кликом_на_Heroku)
    - [Другие методы деплоймента](#другие_варианты_деплоймента_одним_кликом)
- [Архитектура](#архитектура)
- [Инструменты клиентской стороны](#инструменты_клиентской_стороны)
- [Добавление бизнес-логики](#добавить_бизнес-логику)
    - [Схемы удаленного доступа](#схемы_удаленного_доступа)
    - [Запуск webhook по событиям в базе данных](#запуск_webhook_по_событиям_в_базе_данных)
- [Demos](#demos)
    - [Приложения в режиме реального времени](#приложения_в_режиме_реального_времени)
    - [Видео](#видео)
- [Поддержка и устранение неисправностей](#поддержка_и_устранение_неисправностей)
- [Контрибуция](#контрибуция)
- [Элементы бренда](#элементы_бренда)
- [Лицензия](#лицензия)
...
[community/examples](../community/examples) папке.
