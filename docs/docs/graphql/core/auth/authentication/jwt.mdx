...
<Thumbnail src='/img/graphql/core/auth/auth-jwt-overview.png' alt='Authentication using JWT' width='1000px' />
...
<Thumbnail src='/img/graphql/core/auth/jwt-config-generated.png' alt='Generating JWT config' width='75%' />
