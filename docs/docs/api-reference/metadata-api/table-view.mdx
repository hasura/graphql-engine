...
Track a table from the public schema without a custom name. Useful when both schema and table names are specified, especially when no custom name is needed for GraphQL.
