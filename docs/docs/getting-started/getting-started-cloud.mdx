...
<Thumbnail
  src='/img/getting-started/getting-started-cloud-create-project.png'
  alt='Create project'
  width='556px'
/>
...
<Thumbnail src='/img/getting-started/db-setup.png' alt='DB setup' width='556px' />
...
<Thumbnail src='/img/getting-started/connect-db-cloud.png' alt='Enter URL for existing database' width='556px' />
