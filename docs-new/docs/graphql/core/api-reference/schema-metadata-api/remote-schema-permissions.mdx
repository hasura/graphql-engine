...
## add_remote_schema_permissions {#add-remote-schema-permissions}
...
### Args syntax {#add-remote-schema-permissions-syntax}
...
## drop_remote_schema_permissions {#drop-remote-schema-permissions}
...
### Args syntax {#drop-remote-schema-permissions-syntax}
