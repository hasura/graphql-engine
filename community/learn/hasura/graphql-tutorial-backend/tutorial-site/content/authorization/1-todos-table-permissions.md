...
![Todos row permission insert](./todos-table-row-permission-insert.png)

Now under column insert permissions, select the `title` and `is_public` columns.

![Todos insert column permission](./todos-insert-column-permission.png)
...
![Todos select permission row](./todos-select-permission-row.png)

Under column select permissions, select all the columns.

![Todos select column permission](./todos-select-permission-column.png)
...
![Todos update permission](./todos-update-permission.png)
...
![Todos delete permission](./todos-delete-permission.png)
