...
# Cloud: Using Hasura Cloud with an Azure Postgres database <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/azure/select-postgres-db.png' alt='Select Postgres database on Azure' />

Click the `+ Add` button to create a new Postgres database:

<Thumbnail src='/img/graphql/cloud/cloud-dbs/azure/add-postgres-db.png' alt='Add Postgres database on Azure' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/azure/configure-db.png' alt='Configure database on Azure' width='600px' />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/azure/add-hasura-ip.png' alt='Add Hasura IP on Azure' />
...
Back on Hasura Console, enter the database URL that we retrieved in [step 4](#get-db-url-azure):

<Thumbnail src='/img/graphql/cloud/cloud-dbs/azure/azure-complete.png' alt='Database setup' width='600px' />
