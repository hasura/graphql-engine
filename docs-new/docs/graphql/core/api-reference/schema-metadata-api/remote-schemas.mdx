...
## add_remote_schema {#add-remote-schema}
...
```
### Args syntax {#add-remote-schema-syntax}
...
## update_remote_schema {#update-remote-schema}
...
### Args syntax {#update-remote-schema-syntax}
...
## remove_remote_schema {#remove-remote-schema}
...
### Args syntax {#remove-remote-schema-syntax}
...
## reload_remote_schema {#reload-remote-schema}
...
### Args syntax {#reload-remote-schema-syntax}
