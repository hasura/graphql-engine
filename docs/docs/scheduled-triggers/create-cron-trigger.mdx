...
You can define a cron trigger via the [create_cron_trigger](/api-reference/metadata-api/scheduled-triggers.mdx#metadata-create-cron-trigger) metadata API:
...
You can define advanced options for a cron trigger when defining it via the [create_cron_trigger](/api-reference/metadata-api/scheduled-triggers.mdx#metadata-create-cron-trigger) metadata API:
