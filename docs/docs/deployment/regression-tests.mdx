...
<Thumbnail src='/img/deployment/regression-tests/regression-testing-diagram.png' alt='Regression testing process diagram' />
...
<Thumbnail src='/img/deployment/regression-tests/regression-tests-suites.png' alt='Manage regression test suites' />

## Quick-create tests

Add important operations to your test suite with one click by adding them from your project's operation history:

<Thumbnail src='/img/deployment/regression-tests/regression-tests-add-operations.png' alt='Add tests to regression test suites' />
...
<Thumbnail src='/img/deployment/regression-tests/regressions-run-prod-tests-on-dev.png' alt='Run regression tests' />
...
<Thumbnail src='/img/deployment/regression-tests/regression-tests-results.png' alt='Regression test results' />
...
<Thumbnail src='/img/deployment/regression-tests/regression-tests-run-cli.png' alt='Run regression tests via CLI' />
...
<Thumbnail src='/img/deployment/regression-tests/regression-tests-past-runs.png' alt='Regression tests past results' />
