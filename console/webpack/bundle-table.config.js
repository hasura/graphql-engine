...
const relativeAssetsPath = '../packages/console-oss-table/build';
...
module.exports = {
  ...
  entry: {
    main: [
      './src/components/Common/TableCommon/ReactTableOverrides.css',
      './pro-table.js',
    ],
  },
  output: {
  ...
  plugins: [
    new CleanPlugin(['./packages/console-oss-table/build/*.*'], cleanOptions),
