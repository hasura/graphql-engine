...
You can also configure Hasura to have (as shown [here](/graphql/core/remote-schemas/adding-schema#merge-remote-schema)):
...
3. [Fine grained access control](/graphql/core/remote-schemas/auth/remote-schema-permissions#remote-schema-permissions)
