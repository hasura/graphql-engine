...
## pg_create_insert_permission {#pg-create-insert-permission}
...
## pg_drop_insert_permission {#pg-drop-insert-permission}
...
## pg_create_select_permission {#pg-create-select-permission}
...
## pg_drop_select_permission {#pg-drop-select-permission}
...
## pg_create_update_permission {#pg-create-update-permission}
...
## pg_drop_update_permission {#pg-drop-update-permission}
...
## pg_create_delete_permission {#pg-create-delete-permission}
...
## pg_drop_delete_permission {#pg-drop-delete-permission}
...
## pg_set_permission_comment {#pg-set-permission-comment}
