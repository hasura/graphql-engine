...
- [actions.graphql](#actionsgraphql)
- [actions.yaml](#actionsyaml)
- [allow_list.yaml](#allow_listyaml)
- [cron_triggers.yaml](#cron_triggersyaml)
- [functions.yaml](#functions-yaml)
- [query_collections.yaml](#query_collectionsyaml)
- [remote_schemas.yaml](#remote_schemasyaml)
- [tables.yaml](#tables-yaml)
- [version.yaml](#versionyaml)

:::info Note

The output of the [export_metadata](/graphql/core/api-reference/metadata-api/manage-metadata.mdx) metadata API is a JSON
...
definitions and [custom type](/graphql/core/actions/types/index.mdx) definitions.
