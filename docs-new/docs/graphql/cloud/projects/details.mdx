...
:::info Note After renaming, your project might undergo a short downtime due to the DNS resolution as per the new project name. :::
...
This field shows the plan that the project is on. Read about switching pricing plans [here](docs/graphql/cloud/projects/pricing.mdx).
