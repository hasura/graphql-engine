...
some syntactic sugar. See the [API reference](/api-reference/graphql-api/query.mdx#andexp) for more details.
...
explained in the [API reference](/api-reference/graphql-api/query.mdx#orexp)
