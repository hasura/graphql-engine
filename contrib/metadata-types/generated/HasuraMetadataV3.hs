...
data HasuraMetadataV2 = HasuraMetadataV2
    { actionsHasuraMetadataV2 :: Maybe ([Action])
    , allowlistHasuraMetadataV2 :: Maybe ([AllowList])
    , cronTriggersHasuraMetadataV2 :: Maybe ([CronTrigger])
    , customTypesHasuraMetadataV2 :: Maybe CustomTypes
    , functionsHasuraMetadataV2 :: Maybe ([CustomFunction])
    , queryCollectionsHasuraMetadataV2 :: Maybe ([QueryCollectionEntry])
    , remoteSchemasHasuraMetadataV2 :: Maybe ([RemoteSchema])
    , tablesHasuraMetadataV2 :: [TableEntry]
...
data Action = Action
    ...
    , nameAction :: Text
    , permissionsAction :: Maybe ([Permission])
    } deriving (Show)
...
data ActionDefinition = ActionDefinition
    { argumentsActionDefinition :: Maybe ([InputArgument])
    , forwardClientHeadersActionDefinition :: Maybe Bool
    , handlerActionDefinition :: Text
    , headersActionDefinition :: Maybe ([Header])
...
data CustomTypes = CustomTypes
    { enumsCustomTypes :: Maybe ([EnumType])
    , inputObjectsCustomTypes :: Maybe ([InputObjectType])
    , objectsCustomTypes :: Maybe ([ObjectType])
    , scalarsCustomTypes :: Maybe ([ScalarType])
    } deriving (Show)
...
data InputObjectType = InputObjectType
    ...
    , fieldsInputObjectType :: [InputObjectField]
...
data ObjectType = ObjectType
    ...
    , fieldsObjectType :: [InputObjectField]
    , nameObjectType :: Text
    , relationshipsObjectType :: Maybe ([CustomTypeObjectRelationship])
    } deriving (Show)
...
data Definition = Definition
    { queriesDefinition :: [QueryCollection]
    } deriving (Show)
...
data TableEntry = TableEntry
    { arrayRelationshipsTableEntry :: Maybe ([ArrayRelationship])
    , computedFieldsTableEntry :: Maybe ([ComputedField])
    , configurationTableEntry :: Maybe TableConfig
    , deletePermissionsTableEntry :: Maybe ([DeletePermissionEntry])
    , eventTriggersTableEntry :: Maybe ([EventTrigger])
    , insertPermissionsTableEntry :: Maybe ([InsertPermissionEntry])
    , isEnumTableEntry :: Maybe Bool
    , objectRelationshipsTableEntry :: Maybe ([ObjectRelationship])
    , remoteRelationshipsTableEntry :: Maybe ([RemoteRelationship])
    , selectPermissionsTableEntry :: Maybe ([SelectPermissionEntry])
    , tableTableEntry :: QualifiedTable
    , updatePermissionsTableEntry :: Maybe ([UpdatePermissionEntry])
    } deriving (Show)
...
data EventTrigger = EventTrigger
    ...
    , headersEventTrigger :: Maybe ([Header])
...
data EventTriggerColumns
    = EnumInEventTriggerColumns EventTriggerColumnsEnum
    | StringArrayInEventTriggerColumns ([Text])
    deriving (Show)

data EventTriggerColumnsEnum
    = EmptyEventTriggerColumnsEnum
    deriving (Show)
...
data RemoteRelationshipDef = RemoteRelationshipDef
    { hasuraFieldsRemoteRelationshipDef :: [Text]
...
data SelectPermission = SelectPermission
    ...
    , computedFieldsSelectPermission :: Maybe ([Text])
...
data BaseSource = BaseSource
    { functionsBaseSource :: Maybe ([CustomFunction])
    , nameBaseSource :: Text
    , tablesBaseSource :: [TableEntry]
    } deriving (Show)

data PGSource = PGSource
    { configurationPGSource :: PGConfiguration
    , functionsPGSource :: Maybe ([CustomFunction])
    , kindPGSource :: PGSourceKind
    , namePGSource :: Text
    , tablesPGSource :: [TableEntry]
    } deriving (Show)
...
data PGConfiguration = PGConfiguration
    ...
    , readReplicasPGConfiguration :: Maybe ([PGSourceConnectionInfo])
    } deriving (Show)
...
-}
data DatabaseURL
    = FromEnvClassInDatabaseURL FromEnvClass
...
The Postgres user to be connected
-}
data FromEnvClass = FromEnvClass
    { fromEnvFromEnvClass :: Maybe Text
    , databaseFromEnvClass :: Maybe Text
    , hostFromEnvClass :: Maybe Text
    , passwordFromEnvClass :: Maybe Text
    , portFromEnvClass :: Maybe Float
    , usernameFromEnvClass :: Maybe Text
    } deriving (Show)
...
data Datasets
    ...
    | StringArrayInDatasets ([Text])
    deriving (Show)

{-| Service account for BigQuery database -}

data ServiceAccount
    = AnyRecordClassInServiceAccount AnyRecordClass
...
Name of the environment variable
-}
data AnyRecordClass = AnyRecordClass
    { fromEnvAnyRecordClass :: Maybe Text
    } deriving (Show)

data BigQuerySourceKind
    = FluffyBigqueryBigQuerySourceKind
    deriving (Show)

data HasuraMetadataV3 = HasuraMetadataV3
    { actionsHasuraMetadataV3 :: Maybe ([Action])
    , allowlistHasuraMetadataV3 :: Maybe ([AllowList])
    , apiLimitsHasuraMetadataV3 :: Maybe APILimits
    , cronTriggersHasuraMetadataV3 :: Maybe ([CronTrigger])
    , customTypesHasuraMetadataV3 :: Maybe CustomTypes
    , inheritedRolesHasuraMetadataV3 :: Maybe ([InheritedRole])
    , queryCollectionsHasuraMetadataV3 :: Maybe ([QueryCollectionEntry])
    , remoteSchemasHasuraMetadataV3 :: Maybe ([RemoteSchema])
    , restEndpointsHasuraMetadataV3 :: [RESTEndpoint]
    , sourcesHasuraMetadataV3 :: [Source]
...
data UniqueParams
    ...
    | NullInUniqueParams
    | StringArrayInUniqueParams ([Text])
    deriving (Show)
...
data Source = Source
    ...
    , functionsSource :: Maybe ([CustomFunction])
    , kindSource :: BackendKind
    , nameSource :: Text
    , tablesSource :: [TableEntry]
    } deriving (Show)
...
data Configuration = Configuration
    ...
    , readReplicasConfiguration :: Maybe ([PGSourceConnectionInfo])
...
data BackendKind
    = PurpleBigqueryBackendKind
    | PurpleCitusBackendKind
    | PurpleMssqlBackendKind
    | PurplePostgresBackendKind
    deriving (Show)
...
decodeTopLevel :: ByteString -> Maybe AnyRecord
decodeTopLevel = decode
...
instance ToJSON EventTriggerColumnsEnum where
    toJSON EmptyEventTriggerColumnsEnum = "*"

instance FromJSON EventTriggerColumnsEnum where
    parseJSON = withText "EventTriggerColumnsEnum" parseText
        where
            parseText "*" = return EmptyEventTriggerColumnsEnum
...
instance ToJSON AnyRecord where
    toJSON = \_ -> emptyObject

instance FromJSON AnyRecord where
    parseJSON emptyObject = return AnyRecord
...
instance ToJSON DatabaseURL where
    toJSON (FromEnvClassInDatabaseURL x) = toJSON x
    toJSON (StringInDatabaseURL x) = toJSON x

instance FromJSON DatabaseURL where
    parseJSON xs@(Object _) = (fmap FromEnvClassInDatabaseURL . parseJSON) xs
    parseJSON xs@(String _) = (fmap StringInDatabaseURL . parseJSON) xs

instance ToJSON FromEnvClass where
    toJSON (FromEnvClass fromEnvFromEnvClass databaseFromEnvClass hostFromEnvClass passwordFromEnvClass portFromEnvClass usernameFromEnvClass) =
        object
        [ "from_env" .= fromEnvFromEnvClass
        , "database" .= databaseFromEnvClass
        , "host" .= hostFromEnvClass
        , "password" .= passwordFromEnvClass
        , "port" .= portFromEnvClass
        , "username" .= usernameFromEnvClass
        ]

instance FromJSON FromEnvClass where
    parseJSON (Object v) = FromEnvClass
        <$> v .:? "from_env"
        <*> v .:? "database"
        <*> v .:? "host"
        <*> v .:? "password"
...
instance ToJSON PGSourceKind where
    toJSON FluffyCitusPGSourceKind = "citus"
    toJSON FluffyPostgresPGSourceKind = "postgres"

instance FromJSON PGSourceKind where
    parseJSON = withText "PGSourceKind" parseText
        where
            parseText "citus" = return FluffyCitusPGSourceKind
            parseText "postgres" = return FluffyPostgresPGSourceKind
...
instance ToJSON MSSQLSourceKind where
    toJSON FluffyMssqlMSSQLSourceKind = "mssql"

instance FromJSON MSSQLSourceKind where
    parseJSON = withText "MSSQLSourceKind" parseText
        where
            parseText "mssql" = return FluffyMssqlMSSQLSourceKind
...
instance ToJSON ServiceAccount where
    toJSON (AnyRecordClassInServiceAccount x) = toJSON x
    toJSON (StringInServiceAccount x) = toJSON x

instance FromJSON ServiceAccount where
    parseJSON xs@(Object _) = (fmap AnyRecordClassInServiceAccount . parseJSON) xs
    parseJSON xs@(String _) = (fmap StringInServiceAccount . parseJSON) xs

instance ToJSON AnyRecordClass where
    toJSON (AnyRecordClass fromEnvAnyRecordClass) =
        object
        [ "from_env" .= fromEnvAnyRecordClass
        ]

instance FromJSON AnyRecordClass where
    parseJSON (Object v) = AnyRecordClass
        <$> v .:? "from_env"

instance ToJSON BigQuerySourceKind where
    toJSON FluffyBigqueryBigQuerySourceKind = "bigquery"

instance FromJSON BigQuerySourceKind where
    parseJSON = withText "BigQuerySourceKind" parseText
        where
            parseText "bigquery" = return FluffyBigqueryBigQuerySourceKind
...
instance ToJSON BackendKind where
    toJSON PurpleBigqueryBackendKind = "bigquery"
    toJSON PurpleCitusBackendKind = "citus"
    toJSON PurpleMssqlBackendKind = "mssql"
    toJSON PurplePostgresBackendKind = "postgres"

instance FromJSON BackendKind where
    parseJSON = withText "BackendKind" parseText
        where
            parseText "bigquery" = return PurpleBigqueryBackendKind
            parseText "citus" = return PurpleCitusBackendKind
            parseText "mssql" = return PurpleMssqlBackendKind
            parseText "postgres" = return PurplePostgresBackendKind
