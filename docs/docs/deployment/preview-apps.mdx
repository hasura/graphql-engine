...
done in [Step 2](#github-action-step-2) for a personal access token, in
...
If the [hasura/hasura-cloud-preview-apps](#preview-apps-github-action) GitHub action does not suit your needs, you can also directly contact the
[createGitHubPreviewApp](/api-reference/cloud-api-reference.mdx#api-ref-create-preview-app) API to manually setup Preview
