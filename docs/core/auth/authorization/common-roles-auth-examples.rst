...
.. thumbnail:: /img/core/auth/anonymous-role-examples.png
   :class: no-shadow
...
.. thumbnail:: /img/core/auth/user-select-graphiql.png
   :class: no-shadow
...
.. thumbnail:: /img/core/auth/org-manager-graphiql.png
   :class: no-shadow
...
.. thumbnail:: /img/core/auth/collaborator-relationship.png
   :class: no-shadow
...
.. thumbnail:: /img/core/auth/multirole-example-db-schema.png
...
.. thumbnail:: /img/core/auth/multirole-example-reviewers-array-relationship.png
     :class: no-shadow
...
* **Allow users with the role** ``author`` **to insert only their own articles**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-author-insert.png
...
* **Allow users with the role** ``author`` **to select certain columns only**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-author-select.png
...
* **Allow users with the role** ``reviewer`` **to update articles assigned to them for reviews**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-reviewer-update.png
...
* **Allow users with the role** ``reviewer`` **to select articles assigned to them for reviews**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-reviewer-select.png
...
* **Allow editors to select any article's data**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-editor-select.png
...
* **Allow editors to update an article**
  ...
  .. thumbnail:: /img/core/auth/multirole-example-editor-update.png
