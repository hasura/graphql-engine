...
class TestGraphQLQueryBasic(DefaultTestSelectQueries):
    ...
    def test_select_query_person_computed_column(self, hge_ctx):
        check_query_f(hge_ctx, self.dir() + "/select_query_person_computed_column.yaml")
...
class TestGraphqlQueryPermissions(DefaultTestSelectQueries):
    ...
    def test_user_person_computed_column(self, hge_ctx):
        check_query_f(hge_ctx, self.dir() + '/user_select_person_computed_column.yaml')
...
class TestGraphQLQueryBoolExpPostGIS(DefaultTestSelectQueries):
    ...
    def test_query_geography_spatial_ops(self, hge_ctx):
        check_query_f(hge_ctx, self.dir() + '/query_geography_spatial_ops.yaml')
