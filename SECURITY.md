...
(Some sections have been inspired and adapted from [Kubernetes Security Issues](https://github.com/kubernetes/website/blob/master/content/en/docs/reference/issues-security/security.md))
