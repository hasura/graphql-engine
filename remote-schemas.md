...
* [Regular boilerplates](community/boilerplates/) that can be deployed anywhere.
* [Serverless boilerplates](community/boilerplates/) that can be deployed on serverless platforms like AWS Lambda, etc.
