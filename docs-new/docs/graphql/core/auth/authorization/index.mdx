...
- [Inherited roles](/graphql/core/auth/authorization/roles-variables.mdx/)
...
- [Multiple column + row permissions for the same role](/graphql/core/auth/authorization/common-roles-auth-examples.mdx/)
