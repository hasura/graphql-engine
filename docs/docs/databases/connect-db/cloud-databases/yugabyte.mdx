...
# Cloud: Using Hasura Cloud with a Yugabyte Postgres database <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/cloud-dbs/yugabyte/yb-step-2.png' alt='Create cluster on Yugabyte' width='1000px' />
...
<Thumbnail src='/img/graphql/cloud/projects/hasura-cloud-ip.png' alt='Hasura Cloud IP field' />
...
with the information from your credentials downloaded in [step 2](#create-pg-db-yugabyte):

<Thumbnail src='/img/graphql/cloud/cloud-dbs/yugabyte/yb-step-3i.png' alt='Database setup' width='600px' />
