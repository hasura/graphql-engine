...
The export can be done via the `metadata_export_metadata` metadata API.
...
The exported JSON can be imported via the `metadata_replace_metadata`
metadata API.
...
## Reloading Hasura metadata {#reload_metadata_manual_v2}
...
The reload of metadata can be done via the `metadata_reload_metadata`
metadata API.
...
## Resetting Hasura metadata {#reset_metadata_manual_v2}
...
The reset of metadata can be done via the `metadata_clear_metadata`
metadata API.
