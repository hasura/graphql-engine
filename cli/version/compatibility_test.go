...
func TestCheckCLIServerCompatibility(t *testing.T) {
	tt := []struct {
		...
		{
			"untagged version mismatch",
			"some-random-version",
			"some-other-random-version",
			false,
			untaggedBuild,
		},
		...
		{
			"tagged version with server pre-release, major.minor match",
			"v1.3.4",
			"v1.3.4-alpha13",
			true,
			compatibleCLIAndServer,
		},
		{
			"tagged version with cli pre-release major.minor match",
			"v1.3.4-alpha13",
			"v1.3.4",
			true,
			compatibleCLIAndServer,
		...
		{
			"tagged version with cli and server pre-release major.minor match",
			"v1.3.4-alpha13",
			"v1.3.4-alpha13",
			true,
			compatibleCLIAndServer,
		...
		{
			"tagged version major.minor mismatch, server ahead",
			"v2.1.8",
			"v7.2.9",
			false,
			olderCLIVersion,
		...
		{
			"tagged version major.minor mismatch, server behind, different major",
			"v2.1.8",
			"v1.1.1",
			false,
			versionMismatch,
		...
		{
			"tagged version major.minor mismatch, server behind, same major",
			"v2.1.8",
			"v2.0.1",
			true,
			versionMismatch,
		...
		{
			"cloud server and mismatched CLI minor",
			"v2.1.8",
			"v2.0.1-cloud.1",
			true,
			versionMismatch,
