...
1.  Passing a [Table config](/api-reference/syntax-defs.mdx#table-config) with the [ColumnConfig](/api-reference/syntax-defs.mdx#columnconfig) to the
    [mssql_set_table_customization](/api-reference/metadata-api/table-view.mdx#mssql-set-table-customization) API while tracking a table:
...
2.  Customization can be done at the time of creation using
    [mssql_track_table](/api-reference/metadata-api/table-view.mdx#mssql-track-table) API also.
...
1.  Passing a [Table config](/api-reference/syntax-defs.mdx#table-config) with the [Custom Root Fields](/api-reference/syntax-defs.mdx#custom-root-fields) to the
    [mssql_set_table_customization](/api-reference/metadata-api/table-view.mdx#mssql-set-table-customization) API while tracking a table:
