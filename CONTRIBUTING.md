...
*First*: if you feel insecure about how to start contributing, feel free to ask us either on our [Discord channel](https://discordapp.com/invite/hasura) or by sending an email to [Marion](mailto:marion@hasura.io). You can also just go ahead with your contribution and we'll give you feedback. Don't worry - the worst that can happen is that you'll be politely asked to change something. We appreciate any contributions, and we don't want a wall of rules to stand in the way of that. 
