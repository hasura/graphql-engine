...
# Cloud: Dedicated VPC <HeadingIcon icon={`cloud`} size={36} />
...
<Thumbnail src='/img/graphql/cloud/dedicated-vpc/view-vpc-list.png' alt='VPC list' width='1146px' />
...
<Thumbnail src='/img/graphql/cloud/dedicated-vpc/create-vpc-projects.png' alt='Create VPC Project' width='600px' />

All projects within a VPC is listed under **Projects**.

<Thumbnail src='/img/graphql/cloud/dedicated-vpc/vpc-projects-list.png' alt='VPC Projects List' width='900px' />
