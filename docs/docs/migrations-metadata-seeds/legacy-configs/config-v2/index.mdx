...
[Migrations & Metadata (CI/CD)](/migrations-metadata-seeds/index.mdx).
...
The [Hasura CLI](/hasura-cli/index.mdx) lets you manage these pieces of information as you build your project via:
