...
### Args syntax {#create-action-syntax}
...
### Args syntax {#drop-action-syntax}
...
### Args syntax {#update-action-syntax}
...
## create_action_permission {#create-action-permission}
...
### Args syntax {#create-action-permission-syntax}
...
## drop_action_permission {#drop-action-permission}
...
### Args syntax {#drop-action-permission-syntax}
