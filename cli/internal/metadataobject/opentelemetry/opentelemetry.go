...
func (o *OpentelemetryConfig) CreateFiles() error {
	...
	if err := os.WriteFile(filepath.Join(o.MetadataDir, o.Filename()), data, 0o644); err != nil {
		return errors.E(op, err)
	}
...
func (o *OpentelemetryConfig) Build() (map[string]any, error) {
...
func (o *OpentelemetryConfig) error(
	err error,
