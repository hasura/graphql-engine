...
func (c *ClientCatalogState) send(body any, responseBodyWriter io.Writer) (*httpc.Response, error) {
...
func (c ClientCatalogState) Set(key string, state any) (io.Reader, error) {
