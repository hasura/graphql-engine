...
:::note Hasura Cloud the fastest way to production
...
- [Review the summary](/graphql/core/deployment/production-checklist.mdx#review-the-summary)
- [Limit number of rows returned](/graphql/core/deployment/production-checklist.mdx#limit-number-of-rows-returned)
...
### Limit number of rows returned {#limit-number-of-rows-returned}
