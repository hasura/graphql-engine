...
:::note Detailed Logging in Hasura Cloud
...
`HASURA_GRAPHQL_ENABLED_LOG_TYPES` env var. See [GraphQL Engine server config reference](/graphql/core/deployment/graphql-engine-flags/reference.mdx#server-flag-reference)
...
[GraphQL Engine server config reference](/graphql/core/deployment/graphql-engine-flags/reference.mdx#server-flag-reference).
...
For some examples, see [Guides: Integrating with monitoring frameworks](/graphql/core/guides/monitoring/index.mdx)
