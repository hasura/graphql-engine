...
If you are looking for adding authorization & access control for your app users to the GraphQL APIs that are auto-generated via Hasura, head to [auth](/graphql/core/remote-schemas/auth/index.mdx).

:::

:::info Health monitoring of remote schemas in Hasura Cloud

Hasura Cloud offers built-in API metrics with integrated health checks and distributed tracing for your remote schemas. Read more at [Distributed Tracing in Hasura Cloud](/graphql/cloud/tracing).

:::

## Learn more

- [Adding a remote schema](/graphql/core/remote-schemas/adding-schema)
- [Remote schema relationships](/graphql/core/remote-schemas/remote-schema-relationships)
- [Authorization in remote schemas](/graphql/core/remote-schemas/auth/index)
