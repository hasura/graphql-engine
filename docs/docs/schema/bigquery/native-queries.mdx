...
also take a look at the [Logical Models documentation](/schema/bigquery/logical-models.mdx).
...
[Logical Model documentation](/schema/bigquery/logical-models.mdx) for information on attaching permissions.
...
more information in the relevant documentation for [filtering](/queries/bigquery/filters/index.mdx),
