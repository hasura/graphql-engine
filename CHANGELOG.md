...
- server: allow configuring one-off events precision via env var `HASURA_GRAPHQL_ONE_OFF_EVENTS_FETCH_INTERVAL` or server flag `--one-off-events-fetch-interval`
