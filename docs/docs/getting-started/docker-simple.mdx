...
<Thumbnail src='/img/graphql/core/getting-started/connect-db.png' alt='Enter URL for existing database' width='700px' />
...
<Thumbnail src='/img/graphql/core/getting-started/create-profile-table.png' alt='Create a table' width='1200px' />
...
<Thumbnail src='/img/graphql/core/getting-started/profile-query.png' alt='Try out a query' width='1200px' />
...
Set up [Hasura migrations](/migrations-metadata-seeds/migrations-metadata-setup.mdx) to track your database alterations. This will make
it easier to move to a different environment (e.g. staging or prod) later.
