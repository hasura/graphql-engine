...
To represent an enum, we’re going to create an \_<span
class="title-ref">enum table</span>, which for Hasura’s purposes is any
table that meets the following restrictions:
...
<div id="pg_create_enum_table_from_pg_enum">
...
You can also [manually create migration files](/graphql/core/migrations/advanced/writing-migrations-manually.mdx#manual-migrations) to
achieve this.
