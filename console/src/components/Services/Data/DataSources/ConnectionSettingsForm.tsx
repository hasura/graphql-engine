                  ...
                  <Collapse title="Connection Settings" defaultOpen={false}>
                    <Collapse.Content>
                      <div className={styles.connection_settings_form}>
                        <div
                          className={styles.connection_settings_input_layout}
                        >
                          <LabeledInput
                          ...
                          <div className={styles.add_mar_top}>
                            ...
                            {certificateSettingsState ? (
                              <div className={styles.connection_settings_form}>
                                <div
                                  className={
                                    styles.connection_settings_input_layout
                                  }
                                >
                                  <label>
                                    <b>SSL Mode</b>
                                  ...
                                  <select
                                    ...
                                    value={
                                      connectionDBState.sslConfiguration
                                        ?.sslmode
                                    }
                                  >
                                    <option value="">--</option>
                                ...
                                <LabeledInput
                                  ...
                                  value={
                                    connectionDBState.sslConfiguration
                                      ?.sslrootcert?.from_env ?? undefined
                                  }
                                  onChange={e =>
                                    connectionDBStateDispatch({
                                ...
                                <LabeledInput
                                  ...
                                  value={
                                    connectionDBState.sslConfiguration
                                      ?.sslpassword?.from_env ?? undefined
                                  }
                                  onChange={e =>
                                    connectionDBStateDispatch({
