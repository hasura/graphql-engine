...
:::info Note Deployment workflows

For production environments, it is recommended to use other deployment workflows, such as
[GitHub Actions](https://github.com/features/actions), instead of relying solely on the automatic deployment from the GitHub integration.
Refer to the [GitHub Integration Starter Kit](https://github.com/hasura/github-integration-starter/?tab=readme-ov-file#use-github-action)
for more details.
