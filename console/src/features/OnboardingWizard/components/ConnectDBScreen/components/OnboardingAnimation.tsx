      ...
      <div className="flex items-center">
        <div className="animate_3000 opacity-0 bg-white rounded shadow w-48 hover:shadow-md">
          ...
          <div className="relative">
            ...
            <div className="animate_6500 -mt-[2rem] absolute top-[43%] -translate-y-1/2 font-semibold scale-105 w-48 opacity-0 group flex items-center text-sm px-sm rounded shadow border-gray-200 bg-white py-1.5">
