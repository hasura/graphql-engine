...
def send_daily_summary():
    ...
    for notification in notifications:
        ...
        outcomes.append({
            'messageId': 'N/A',  # Replace with the actual message ID
            'previewUrl': 'N/A',  # Replace with the actual preview URL
        })

    return jsonify({'message': 'Notifications sent!', 'outcomes': outcomes})
