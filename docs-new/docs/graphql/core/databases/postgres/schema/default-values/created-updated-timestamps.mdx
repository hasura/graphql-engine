...
You can add a `created_at` timestamp by using the [run_sql](/graphql/core/api-reference/schema-api/run-sql.mdx)
schema API:
...
You can add an `updated_at` timestamp by using the [run_sql](/graphql/core/api-reference/schema-api/run-sql.mdx)
schema API.
