...
1.  [Create a migration manually](/migrations-metadata-seeds/manage-migrations.mdx#create-manual-migrations) and add your
    [create view SQL statement](https://www.postgresql.org/docs/current/static/sql-createview.html) to the `up.sql`
...
<Thumbnail src='/img/graphql/core/schema/schema-track-views.png' alt='Track views' />
