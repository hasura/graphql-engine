...
!(function(e) {
  ...
  function d(e, r, n, i) {
    ...
    function g() {
      const e = typeof k.sL === 'string';
      if (e && !E[k.sL]) return t(M);
      const r = e ? d(k.sL, M, !0, x[k.sL]) : b(M, k.sL.length ? k.sL : void 0);
      return (
        k.r > 0 && (B += r.r),
        e && (x[k.sL] = r.top),
    ...
    function v(e, t) {
      if (((M += e), t == null)) return _(), 0;
      const r = c(t, k);
      if (r) {
        return (
          r.skip ? (M += t) : (r.eB && (M += t), _(), r.rB || r.eB || (M = t)),
          h(r, t),
          r.rB ? 0 : t.length
        );
      }
      ...
      if (a) {
        ...
        do k.cN && (C += R), k.skip || k.sL || (B += k.r), (k = k.parent);
        while (k !== a.parent);
        return (
          a.starts &&
    ...
    try {
      ...
      if (I.message && I.message.indexOf('Illegal') !== -1) {
  ...
  return (
    ...
    e.registerLanguage('cpp', e => {
      let t = { cN: 'keyword', b: '\\b[a-z\\d_]*_t\\b' },
        r = {
          cN: 'string',
          v: [
            { b: '(u8?|U|L)?"', e: '"', i: '\\n', c: [e.BE] },
    ...
    e.registerLanguage('java', e => {
      let t = '[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*',
        r = t + '(<' + t + '(\\s*,\\s*' + t + ')*>)?',
        a =
    ...
    e.registerLanguage('php', e => {
      let t = { b: '\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*' },
        r = { cN: 'meta', b: /<\?(php)?|\?>/ },
        a = {
          cN: 'string',
          c: [e.BE, r],
    ...
    e.registerLanguage('properties', e => {
      let t = '[ \\t\\f]*',
        r = '[ \\t\\f]+',
        a = '(' + t + '[:=]' + t + '|' + r + ')',
        n = '([^\\\\\\W:= \\t\\f\\n]|\\\\.)+',
      ...
      return {
        ...
        c: [
          ...
          },
          {
            ...
            rB: !0,
            r: 0,
            c: [{ cN: 'meta', b: i, endsParent: !0, r: 0 }],
            starts: s,
          },
          { cN: 'attr', r: 0, b: i + t + '$' },
        ],
