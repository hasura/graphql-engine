...
<Thumbnail src='/img/graphql/cloud/projects/regions-while-creation.png' alt='select regions while project creation' />
...
<Thumbnail src='/img/graphql/cloud/projects/region-edit-before.png' alt='select regions while project creation' />
...
<Thumbnail src='/img/graphql/cloud/projects/region-change-confirmation.png' alt='change region confirmation' />
