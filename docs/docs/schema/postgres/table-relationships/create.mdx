...
<Thumbnail src="/img/schema/add-foreign-key.png" alt="Add foreign-key constraint" width="700px" />
...
<Thumbnail src="/img/schema/schema-track-relationships.png" alt="Track all relationships" width="700px" />
