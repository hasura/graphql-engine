...
## rename_query_collection {#schema-metadata-rename-query-collection}
...
### Args syntax {#schema-metadata-rename-query-collection-syntax}

| Key      | Required | Schema                                                          | Description                                 |
| -------- | -------- | --------------------------------------------------------------- | ------------------------------------------- |
| name     | true     | [CollectionName](/api-reference/syntax-defs.mdx#collectionname) | Name of the query collection to be replaced |
| new_name | true     | [CollectionName](/api-reference/syntax-defs.mdx#collectionname) | New name of the query collection            |
