...
<Thumbnail src='/img/graphql/core/schema/column-presets-option.png' alt='Add a column preset in the permissions tab' />
...
<Thumbnail src='/img/graphql/core/schema/column-presets-value-options.png' alt='Configure the column preset' />
...
<Thumbnail src='/img/graphql/core/schema/column-preset-schema-change-for-role.png' alt='Write an insert mutation' />
...
<Thumbnail src='/img/graphql/core/schema/column-preset-mutation-result.png' alt='Write an insert mutation' />
