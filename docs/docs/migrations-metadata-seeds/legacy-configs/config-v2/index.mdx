...
For `config v3`, see [Migrations & Metadata (CI/CD)](/migrations-metadata-seeds/index.mdx).
...
The [Hasura CLI](/hasura-cli/index.mdx) lets you manage these pieces of
...
See [Setting up Hasura migrations (config v2)](/migrations-metadata-seeds/legacy-configs/config-v2/migrations-setup.mdx).
