...
the [API reference](/api-reference/graphql-api/query.mdx#jsonb-operators).
...
equivalents, refer to the [API reference](/api-reference/graphql-api/query.mdx#geometry-operators).
...
equivalents, refer to the [API reference](/api-reference/graphql-api/query.mdx#intersect-operators).
...
the [API reference](/api-reference/graphql-api/query.mdx#ltree-operators).
