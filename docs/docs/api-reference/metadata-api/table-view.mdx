...
`pg_track_tables` is supported for versions `v2.25.0` and above.
...
`mssql_track_tables` is supported for versions `v2.25.0` and above.
...
`bigquery_track_tables` is supported for versions `v2.25.0` and above.
