...
- [Row-level permissions](/graphql/core/auth/authorization/permission-rules.mdx#row-level-permissions)
- [Column-level permissions](/graphql/core/auth/authorization/permission-rules.mdx#col-level-permissions)
- [Aggregation queries permissions](/graphql/core/auth/authorization/permission-rules.mdx#aggr-query-permissions)
- [Row fetch limit](/graphql/core/auth/authorization/permission-rules.mdx#limit-rows-permissions)
...
- [Row-level permissions](/graphql/core/auth/authorization/permission-rules.mdx#row-level-permissions)
- [Column-level permissions](/graphql/core/auth/authorization/permission-rules.mdx#col-level-permissions)
- [Column presets](/graphql/core/auth/authorization/permission-rules.mdx#col-presets-permissions)
- [Backend only](/graphql/core/auth/authorization/permission-rules.mdx#backend-only-permissions)
...
[permissions metadata API](/graphql/core/api-reference/metadata-api/permission.mdx#metadata-api-permission):
...
:::note Array session variables in permission rules
...
You can leverage [table relationships](/graphql/core/databases/postgres/schema/table-relationships/index.mdx#pg-table-relationships) to
...
:::note Array and object relationships work similarly
