...
-   Configures necessary project settings i.e setting environment
    ...
    [list](#vercel-environment-variables) of all environment variables set).
...
-   Once you are logged in, a Hasura Cloud project is created for the
    ...
    [environment variables](#vercel-environment-variables) are set for
...
-   Click on the first link to navigate to your Hasura Cloud project
    ...
    Check out the section on [database setup](/graphql/cloud/projects/create.mdx#cloud-projects-db-setup)
    on how to do this.
...
-   To change the scope of you integration, you can click on
    ...
    integration. Check out the [Adding and removing projects from the Scope of Integration](#vercel-change-scope) section for more
    details.
...
-   List of Hasura Cloud environment variables configured by the
    ...
    -   You can check the environment variables configured by the
        ...
        `Preview` and `Production` environments. Check the [Vercel docs](https://vercel.com/docs/concepts/projects/environment-variables)
...
-   If a [custom domain](/graphql/cloud/projects/domains.mdx#manage-project-domains) is added to the Hasura
