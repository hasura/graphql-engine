...
getQueryOp gCtx sqlGenCtx manager reqHdrs userInfo queryReusability actionExecuter fields =
  runE gCtx sqlGenCtx userInfo $
    EQ.convertQuerySelSet manager reqHdrs queryReusability fields actionExecuter
