...
func (c *ClientCommonMetadataOps) send(
	body any,
	responseBodyWriter io.Writer,
) (*httpc.Response, error) {
...
func (c *ClientCommonMetadataOps) ReplaceMetadata(metadata io.Reader) (io.Reader, error) {
	var (
		op   errors.Op = "commonmetadata.ClientCommonMetadataOps.ReplaceMetadata"
		body any
	)
...
func (c *ClientCommonMetadataOps) SendCommonMetadataOperation(
	body any,
) (*httpc.Response, io.Reader, error) {
