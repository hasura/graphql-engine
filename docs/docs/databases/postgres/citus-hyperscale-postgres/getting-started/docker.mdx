...
# or run
curl https://raw.githubusercontent.com/hasura/graphql-engine/main/install-manifests/docker-compose/docker-compose.yaml -o docker-compose.yaml
```
...
If you're testing Hasura with Citus running locally,
