...
$(J.deriveJSON (J.aesonDrop 3 J.camelCase){J.omitNothingFields = True} ''WrkBenchArgs)
...
$(J.deriveJSON (J.aesonDrop 4 J.camelCase){J.omitNothingFields = True} ''Wrk2BenchArgs)
