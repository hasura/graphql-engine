...
Read more about adding new component and how to import in the "TODO: Working with React" section.
...
Please refer `Table of Contents` section to understand more about hwo to render this manually in between content and filtering items etc.,
