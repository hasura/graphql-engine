...
$(J.deriveJSON (J.aesonPrefix J.snakeCase) ''ArgumentDefinition)
...
$(J.deriveToJSON (J.aesonPrefix J.snakeCase) ''ActionPermissionInfo)
...
$(J.deriveJSON (J.aesonPrefix J.snakeCase) ''CreateAction)
...
$(J.deriveJSON (J.aesonPrefix J.snakeCase) ''UpdateAction)
...
$(J.deriveJSON (J.aesonPrefix J.snakeCase) ''CreateActionPermission)
...
$(J.deriveJSON
  (J.aesonPrefix J.snakeCase){J.omitNothingFields=True}
  ''ActionPermissionMetadata)
...
$(J.deriveToJSON (J.aesonPrefix J.snakeCase) ''ActionMetadata)
...
$(J.deriveJSON (J.aesonPrefix J.snakeCase) ''ActionLogResponse)
