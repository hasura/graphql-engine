...
When you use  the ``_in`` operator in the permissions builder (in Hasura console), it will automatically open an array for your values. If your value is already an array, you can manually edit the permission expression (shown above the builder) to remove the brackets.
