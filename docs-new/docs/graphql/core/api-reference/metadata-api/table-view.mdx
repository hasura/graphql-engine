...
## pg_untrack_table {#pg-untrack-table}
...
## pg_set_table_is_enum {#pg-set-table-is-enum}

`pg_set_table_is_enum` sets whether an already-tracked table should be
used as an `enum table <pg_create_enum_table>`.
...
## pg_set_table_customization {#pg-set-table-customization}
...
## bigquery_track_table {#bigquery-track-table}
...
## bigquery_untrack_table {#bigquery-untrack-table}
...
## bigquery_set_table_customization {#bigquery-set-table-customization}
