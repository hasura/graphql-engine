...
| [schema_run_sql](/graphql/core/api-reference/schema-api/run-sql.mdx) | [run_sql_args](/graphql/core/api-reference/schema-api/run-sql.mdx)| 1         | Run SQL directly on Postgres                  |
