.. meta::
   :description: User's manual for using remote schemas with the Hasura schema/metadata API
   :keywords: hasura, docs, schema/metadata API, reference, remote schema
