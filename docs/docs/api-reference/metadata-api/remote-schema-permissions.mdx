...
1.  Static Value
2.  [Session Variable](/auth/authorization/roles-variables.mdx#session-variables)
...
[session variable value](/auth/authorization/roles-variables.mdx#session-variables), then its value
