...
title: 'Cloud: Manually moving Hasura Cloud v1.3 projects to Hasura v2.0'
keywords:
  - hasura
  - docs
  - project
...
# Cloud: Manually moving Hasura Cloud v1.3 projects to Hasura v2.0 <HeadingIcon icon={`cloud`} size={36} />
