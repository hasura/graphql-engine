...
gqlSpecFiles =
  ...
  , "insert_mutation/article_on_conflict_error_04.yaml"
  , "insert_mutation/article_on_conflict_error_05.yaml"
  , "insert_mutation/article_on_conflict_role_user_error_01.yaml"
