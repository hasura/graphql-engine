...
## create_query_collection {#create-query-collection}
...
### Args Syntax {#create-query-collection-syntax}
...
## drop_query_collection {#drop-query-collection}
...
### Args syntax [#drop-query-collection-syntax]
...
## add_query_to_collection {#add-query-to-collection}
...
### Args Syntax [#add-query-to-collection-syntax]
...
### Args Syntax {#drop-query-from-collection-syntax}
...
## add_collection_to_allowlist {#add-collection-to-allowlist}
...
### Args Syntax {#add-collection-to-allowlist-syntax}
...
## drop_collection_from_allowlist {#drop-collection-from-allowlist}
...
### Args Syntax {#drop-collection-from-allowlist-syntax}
