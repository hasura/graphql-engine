...
<Thumbnail src='/img/graphql/cloud/metrics/integrate-datadog.png' alt='Configure Datadog Integration' width='1146px' />
...
<Thumbnail src='/img/graphql/cloud/metrics/configure-datadog.png' alt='Configure Datadog Integration' width='500px' />
