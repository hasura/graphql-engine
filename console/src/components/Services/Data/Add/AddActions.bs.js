...
var _SET_COLUMN_ALIAS = 'AddTable/SET_COL_ALIAS';
...
var _SET_ROOT_FIELD_ALIAS = 'AddTable/SET_ROOT_FIELD_ALIAS';

var rootFieldTypes = /* array */ [
  'select',
  'select_by_pk',
  'select_aggregate',
  'insert',
...
function setDefaultAliases(tableName, dispatch) {
  $$Array.iteri(function(param, rootFieldType) {
