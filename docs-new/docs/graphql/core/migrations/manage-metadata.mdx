...
## Exporting Hasura metadata {#exporting_metadata}
...
## Applying/Importing Hasura metadata {#applying_metadata}
...
## Reloading Hasura metadata {#reload_metadata_manual}
...
## Resetting Hasura metadata {#reset_metadata_manual}
