    ...
    packages = super.haskell.packages // {
      ${super.ghcName} = super.haskell.packages.${super.ghcName}.override {
        overrides = hself: hsuper: {
          ...
          graphql-server = super.haskell.lib.dontCheck (super.haskell.lib.doJailbreak (hsuper.callPackage ../../server {
             hedgehog = hself.hedgehog_1_2;
          }));
          ...
          ekg-prometheus = super.haskell.lib.doJailbreak (hsuper.callCabal2nix "ekg-prometheus"
          ...
          kriti-lang = hsuper.callCabal2nix "kriti-lang" (super.fetchFromGitHub {
            owner = "hasura";
            repo = "kriti-lang";
            rev = "v0.3.3";
          ...
          servant-openapi3 = super.haskell.lib.doJailbreak hsuper.servant-openapi3;
        };
      };
    };
  };
