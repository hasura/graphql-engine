...
The Hasura CLI is a command line tool which, along with the Hasura Console is one of the primary modes of managing
your Hasura instances.

Most often with Hasura CLI you will be working with Hasura Migrations and Hasura Metadata. [Check out the
documentation on those](/migrations-metadata-seeds/index.mdx) to see how they work.
